...
1. **عزل التنبيه الميكانيكي حصرياً لخدمة DOD:**
   ...
   - 🛑 **يُمنع منعاً باتاً وقاطعاً** ذكر التكايات أو الفك الميكانيكي عند الحديث عن برمجة المراوح، فحص الكمبيوتر، التكييف، أو أي خدمة أخرى! خلط التكايات ببرمجة المراوح يُعتبر خطأً شنيعاً وذكاءً اصطناعياً غبياً مرفوضاً كلياً!

2. **المدة الزمنية الواقعية والدقيقة للخدمات (ممنوع التهويل بمدة اليوم أو الغد):**
